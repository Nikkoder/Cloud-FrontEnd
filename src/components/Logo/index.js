...
export const Logo = (props) => {
  return (
    <Svg
      ...
      viewBox="-19.951 13.989 539.903 122.021"
      style={{
        background: "0 0",
      }}
    ...
    >
      <defs>
        ...
        <filter
          ...
          height="300%"
        >
          <feFlood floodColor="#cde9f1" result="flood" />
          <feComposite
            operator="in"
            in2="SourceAlpha"
            in="flood"
